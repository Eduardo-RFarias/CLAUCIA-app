...
class _CreateWoundScreenState extends State<CreateWoundScreen> {
  ...
  Future<void> _pickImage(ImageSource source) async {
    try {
      ...
      if (pickedFile != null) {
        await _cropAndResizeImage(pickedFile.path);
      }
    } catch (e) {
      Get.snackbar(
        'Error',
  ...
  Future<void> _cropAndResizeImage(String imagePath) async {
    try {
      ...
      if (croppedFile != null) {
        ...
        if (image != null) {
          ...
          final fileName = 'wound_${timestamp}_224x224.jpg';
